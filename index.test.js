...
test('rejects an error with the message "number must be a number" if passed a non-number', async () => {
try {
...
test('rejects an error with the message "number must be a number" if passed a NaN', async () => {
  try {
